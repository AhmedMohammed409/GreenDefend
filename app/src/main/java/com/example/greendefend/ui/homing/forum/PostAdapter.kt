...
class PostAdapter(private val context: Context,private var onItemClicked:(post:Post)->Unit):ListAdapter<Post,PostAdapter.ViewHolder>(PostsDiffUtil) {
    ...
    inner class ViewHolder(private val binding: RowForumBinding) :
        ...
        fun bind(item: Post, onItemClicked: (item: Post) -> Unit) {
            binding.post=item
